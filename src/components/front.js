    ...
    return (
      <div className={styles.front}>
        ...
        <div className={styles.frontContainer}>
          ...
          <h2 className={styles.tagline}>This site was edited to be a static page and to display what bytelab used to be</h2>
          <h2 className={styles.subtext}>
            <a className={styles.link} rel={"noopener noreferrer"} target={"_blank"} href={"https://hackclub.com"}>
              hack club
            </a> @ <a className={styles.link} href={"#"}>
              lowell high school
            </a>.
          </h2>
        </div>
